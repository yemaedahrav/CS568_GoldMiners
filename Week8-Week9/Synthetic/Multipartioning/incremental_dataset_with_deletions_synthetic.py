# -*- coding: utf-8 -*-
"""Incremental_Dataset_with_deletions_synthetic

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Ovrg2iHQtILZEiHqj01TreWw6whbrAbx
"""
...
def create_incremental_dataset(initial, n_batches, ind):
  ...
  f.write("{} {} {} {}\n".format(w,initial,n_cluster,num_of_edges(0,initial))) 
  print("{} {} {} {}\n".format(w,initial,n_cluster,num_of_edges(0,initial)))  
  for i in range(w):
...
create_incremental_dataset(1400,5,"")